...
public class TileMap : MonoBehaviour {
	...
	/*	int numTiles = terrainTiles.width / tileResolution;
		Debug.Log ("tileResolution = " + tileResolution);
		...
		for(int y = 0; y < size_z; y++){
			...
			/*	Color c = new Color (Random.Range(0f, 1f), Random.Range(0f, 1f), Random.Range(0f, 1f));
				...
				Color[] p = tiles[map.GetTileAt(x, y)/*Random.Range(0, 4)*/];
	...
	public void BuildMesh (){
		...
		for (x = 0; x < vsize_x; x++) {
			for (z = 0; z < vsize_z; z++) {
				vertices [z * vsize_x + x] = new Vector3 (x * tileSize, /*Random.Range(-1f, 1f)*/ 0, z * tileSize);
		...
		*/
		...
		//Assing our mesh to our filter/renderer/collider
